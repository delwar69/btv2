...
urlpatterns = [
    ...
    path('all_committee_members/', views.all_committee_members, name='all_committee_members'),
    path('gallery/', views.all_gallery_images, name='all_gallery_images'),  # New URL for all gallery images
    # Home View
